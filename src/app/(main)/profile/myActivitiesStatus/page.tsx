  ...
  const handleDayClick = (clickedDate: Date, event?: MouseEvent) => {
    ...
    if (apiReservationData[key]) {
      ...
      if (event?.target) {
        ...
        console.log('✅ 최종 모달 위치:', { left: modalLeft, top: modalTop });
      ...
      // 🎯 예약이 없는 날짜 클릭시 모달 닫기
      console.log('No data found for date:', key, '- 모달 닫기');
      closeModal();
    }
  };
